...
const Header = () => {
  ...
  return (
    <div className="">
      ...
      <div className="w-full text-white bg-[#095749]">
        <div className="relative flex flex-col px-4 mx-auto md:items-center md:justify-between md:flex-row md:px-6 lg:px-8">
          ...
          <nav
            className={`transition-all duration-300 ease-in-out overflow-hidden gap-4 flex-col md:flex-row space-y-2 md:space-y-0 ${
              showMenu ? "max-h-screen" : "max-h-0"
            } md:max-h-none`}
          >
            <div
              className={`flex md:items-center flex-grow md:gap-4 flex-col md:flex-row ${
                showMenu ? "show" : ""
